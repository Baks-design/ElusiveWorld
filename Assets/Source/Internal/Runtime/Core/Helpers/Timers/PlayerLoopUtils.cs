...
namespace ElusiveWorld.Core.Assets.Scripts.Systems.Game.Timers
{
    public static class PlayerLoopUtils
    {
        ...
        static void HandleSubSystemLoopForRemoval<T>(
            ref PlayerLoopSystem loop, PlayerLoopSystem systemToRemove)
        {
            if (loop.subSystemList == null) return;
        ...
        public static bool InsertSystem<T>(
            ref PlayerLoopSystem loop, in PlayerLoopSystem systemToInsert, int index)
        {
