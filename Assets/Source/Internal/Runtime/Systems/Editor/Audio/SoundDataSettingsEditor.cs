...
namespace ElusiveWorld.Core.Assets.Scripts.Systems.Sound
{
    ...
    public class SoundDataSettingsEditor : Editor
    {
        ...
        void DrawSliderLabels(Rect totalRect, string leftLabel, string rightLabel)
        {
            ...
            var leftStyle = new GUIStyle(EditorStyles.miniLabel) { alignment = TextAnchor.UpperLeft };
        ...
        {
            var tempObj = new GameObject("TempAudioSource") { hideFlags = HideFlags.HideAndDontSave };
