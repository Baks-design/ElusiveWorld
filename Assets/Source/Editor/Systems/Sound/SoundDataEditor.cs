...
namespace ElusiveWorld.Core.Assets.Scripts.Systems.Sound
{
    ...
    public class SoundDataEditor : Editor
    {
        ...
        void DrawPreviewButtons()
        {
            ...
            if (GUILayout.Button("At Distance", GUILayout.Width(100))) PlayPreview(true, true);
        ...
        void PlayPreview(bool applySettings, bool applyDistance)
        {
            ...
            if (applySettings && soundData.settings != null)
            {
                ...
                else previewSource.spatialBlend = settings.spatialBlend;  
            }
            else
            {
        ...
        void DrawValidation()
        {
            ...
            if (soundData.clips.All(t => t != null)) return;
        ...
        void DrawSettingsPreview()
        {
            ...
            unlockSettings = GUILayout.Toggle(unlockSettings, unlockSettings ?
                "Lock Settings" : "Edit Settings", "Button", GUILayout.Width(100f));
            EditorGUILayout.EndHorizontal();
